...
CubeHeuristics.corners = [0, 1, 2, 3, 4, 5, 6, 7];
//6
...
{
    //Math.max(CubeHeuristics.manhattanDistanceOfAllEdges(rubixState),
    return CubeHeuristics.manhattanDistanceOfCorners(rubixState);
};
...
CubeHeuristics.manhattanDistanceOfCorners = function(rubixState)
{
    ...
    {                    
        ...
        else if(CubeHeuristics.farCorners[index].indexOf(cubie)!= -1)
        {
            moves = 2;
        }
        else
